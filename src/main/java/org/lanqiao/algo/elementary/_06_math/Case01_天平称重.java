...
public class Case01_天平称重 {
    public static void main(String[] args) {
        ...
        // m1(N);
        //转成3进制
        final String x = Integer.toString(N, 3);//左边高位，右边低位
        //翻转后转成字符数组
        char[] arr = new StringBuilder(x).reverse().toString().toCharArray();//左边低位，右边高位
        //容器放处理之后的0 -1 1
        ...
        System.out.println(sb.substring(1));  //sb.substring(1) 去除第一个字符
    }
